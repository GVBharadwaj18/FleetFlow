...
const InvoicePrintModal = forwardRef(({ bill, onCancel, onConfirm }, ref) => {
    ...
    return (
        <div ref={ref} className="bg-white dark:bg-surface-900 p-6 rounded shadow max-w-xl mx-auto text-gray-800 print:block print:shadow-none">
            ...
            <p><strong>Total Price:</strong> {Number(bill.totalPrice || 0).toLocaleString()} €</p>
